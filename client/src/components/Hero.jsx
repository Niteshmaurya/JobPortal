    ...
    return (
        ...
        <div className='container 2xl:px-20 mx-auto my-10'>
            <div className='bg-gradient-to-r from-purple-800 to-purple-950 text-white py-16 text-center mx-2 rounded-xl '>
                <h2 className='text-2xl md:text-3xl lg:text-4xl front-medium mb-4'>
                ...
                <div className='flex items-center justify-between bg-white rounded text-gray-600 max-w-xl pl-4 mx-4 sm:mx-auto '>
                    <div className='flex items-center'>
                        ...
                        <input type="text"
                            ...
                            className='max-sm:text-ss p-2 rounded outline-none w-full'
                            ref={titleRef} />
                    </div>
                    ...
                    <button onClick={onSearch} className='bg-blue-600 px-6 py-2 rounded-none text-white m-1 '>Search</button>
                </div>
            </div>
