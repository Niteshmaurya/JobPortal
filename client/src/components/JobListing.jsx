...
const JobListing = () => {
    ...
    }, [jobs, selectedCategories, selectedCategories, selectedLocations, searchFilter])


    return (
        <div className='container 2xl:px-20 mx-auto flex flex-col lg:flex-row max-lg:flex-row max-lg:space-y-8 py-8'>

            {/* sidebar */}
            <div className='w-full lg:w-1/4 bg-white px-4'>


                {/* search filter from hero compo */}
                {
                            ...
                            JobCategories.map((catergory, index) => (
                                <li className='flex gap-3 items-center' key={index}>
                                    <input className='scale-125'
                                        type="checkbox"
                                        onChange={() => handleCategoryChange(catergory)}
                                        checked={selectedCategories.includes(catergory)}
                                    />
                                    {catergory}
                                </li>
                            ))
